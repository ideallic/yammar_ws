...
if("FALSE" STREQUAL "TRUE")
  set(mmw_capture_SOURCE_PREFIX /home/sjtu_wanghaili/yammar_ws/src/mmw_capture)
  set(mmw_capture_DEVEL_PREFIX /home/sjtu_wanghaili/yammar_ws/src/cmake-build-debug/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mmw_capture' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
